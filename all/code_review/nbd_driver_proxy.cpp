...
// Declarations ---------------------------------------------------------------
// TODO: Static is not the same as C! these functions are available to all hrd11 namespace.
// TODO: Put these functions in a class / struct or write as a
// TODO: comment that these are namespace functions..
...
//TODO: maybe put these in .hpp ? I'm not sure..
enum SocketName
{
	REQUEST = 0,
	NBD = 1
...
NBDDriverProxy::NBDDriverProxy(
	...
	m_connected(ON)
{
	// TODO: these two functions could be of private in NBDDriverProxy class.
...
std::unique_ptr<DriverData> NBDDriverProxy::ReceiveRequest()
{
	...
	ssize_t bytes_read = 0; // TODO: could delete this variable.
	std::unique_ptr<DriverData> ret(new DriverData(0)); // NOTE: interesting idea..

	memset(&request, 0, sizeof(request));

	// TODO: could put this in if condition insted of checking the variable.
	...
	// TODO: maybe use a default Ctor for DriverData which only recieve type
	// TODO: and another Ctor for write and read that receive offset, len,
	// TODO: WRITE/READ and have default argument for vector size and both have default argument status.
...
void NBDDriverProxy::Disconnect()
{
	...
	m_connected = 0; // TODO: fix to enum.
}
...
static void ThreadFuncSetNBD(int file_fd, int socket_fd)
{
	...
	{
		std::cout << e.what();
		//NOTE: take care of your own TODO's
...
static void SubThreadSetSignals()
{
	...
	stt += pthread_sigmask(SIG_SETMASK, &sigset, NULL); //TODO: change NULL "C style" to nullptr / 0
