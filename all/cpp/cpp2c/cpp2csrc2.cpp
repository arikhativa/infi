...
public:
  ...
  LegendaryAnimal(const LegendaryAnimal& other) :
  			Animal(other),
  			m_a1(new Centipede(*(Centipede*)other.m_a1)),
  			m_a2(new Squirl(*(Squirl*)other.m_a2)),
  			m_c(Centipede(other.m_c)),
  			m_sq(Squirl(other.m_sq))
  {}
  // LegendaryAnimal& operator=(const LegendaryAnimal& other)
  // {
  // 	m_a1 = new Centipede(*(Centipede*)other.m_a1);
  // 	m_a2 = new Squirl(*(Squirl*)other.m_a2);
  //
