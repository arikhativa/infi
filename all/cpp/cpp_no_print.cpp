...
public:
   ...
   ~Minibus()
   {
	...
	virtual void Wash()
	{
		// cout << "Minibus::Wash() ID:"<<GetID() << endl;
	}
...
public:
	...
	Taxi(const Taxi &other ): Public_Transport(other)
	{
		 // cout << "Taxi::CCtor()" << endl;
	  }
   ~Taxi()
   {
	    // cout << "Taxi::dtor()" << endl;
	...
	{
		 GetID();
		 // cout << "Taxi::Display() ID:"<<GetID()<< endl;
	 }
...
public:
   ...
   ~Special_Taxi()
   {
	    // cout << "Special_Taxi::dtor()" << endl;
}
	void Display()
	{
		GetID();
		 // cout << "Special_Taxi::Display() ID:"<<GetID()<<endl;
	 }
};
